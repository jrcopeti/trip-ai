...
- **AI Powered Travel Guide** - Trip AI uses Anthropic's Claude Sonnet to generate personalized travel itineraries based on your preferences.
...
- **Anthropic API** - to generate personalized travel itineraries.
