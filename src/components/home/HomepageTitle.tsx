...
function HomepageTitle() {
  return (
    <div className="-mt-4 flex flex-col gap-4 p-2 xs:-mt-8 xs:gap-2 xs:p-6 sm:p-4 md:p-6 lg:p-8 xl:px-14 xl:py-4">
      <div className="mt-0 max-w-3xl xs:mt-4 sm:mt-8 lg:mt-12">
