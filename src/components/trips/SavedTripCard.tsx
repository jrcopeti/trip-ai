...
function SavedTripCard({ trip }: { trip: Trip }) {
  ...
  return (
    <Link
      href={`/saved-trips/${id}`}
      className="trip-card relative flex h-[40vh] w-[40vh] max-w-[40vh] min-h-[40vh] flex-col rounded-sm bg-gallery-100 px-4 py-3 opacity-0 shadow-md transition duration-300 ease-in-out"
    >
      <div>
