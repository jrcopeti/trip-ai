  ...
  return (
    <>
      <div className="trip-description grid h-[90%] w-[90%] grid-cols-none grid-rows-2 shadow-sm lg:h-[80%] lg:w-[80%] lg:grid-cols-2 lg:grid-rows-none ">
        <div className="bg-gallery-50/45 p-6 xs:p-8 sm:p-8 md:p-10 lg:p-12 xl:p-14 ">
          <p className="text-sm font-semibold text-tuna-900 sm:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl ">
            {trip?.description}
          </p>
        </div>
