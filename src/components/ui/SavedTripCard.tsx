...
function SavedTripCard({ trip }: { trip: any }) {
  ...
  return (
    <Link
      href={`/saved-trips/${id}`}
      className="trip-card flex h-[40vh] w-[40vh] flex-col rounded-sm bg-gallery-100 px-4 py-3 opacity-1 md:opacity-0 shadow-md transition duration-300 ease-in-out hover:-translate-y-2 "
    >
      <div>
